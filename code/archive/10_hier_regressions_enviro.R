...
spp_combo = expand.grid("species_1" = unique(enviro$name),
                        "species_2" = unique(enviro$name))
...
# first pivot wider
enviro = tidyr::pivot_wider(enviro[,1:3], names_from="name",values_from = "cov")
