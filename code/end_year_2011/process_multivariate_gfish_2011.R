...
for(i in 1:18) {
  ...
  d = readRDS(file = paste0("output/multivariate/",df$predictors[i],"_",df$model[i],"_",df$years_ahead[i],"step_2011.rds"))
...
saveRDS(out, "output/summaries/parameteric_multivariate_2011.rds")
...
saveRDS(out, "output/summaries/nonparameteric_multivariate_2011.rds")
saveRDS(out_all, "output/summaries/nonparameteric_multivariate_raw_2011.rds")
