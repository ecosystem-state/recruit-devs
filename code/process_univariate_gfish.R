...
for(i in 1:nrow(df)) {
  ...
  d = readRDS(file = paste0("output/",df$response[i],"/",df$predictors[i],"_",df$model[i],"_",df$years_ahead[i],"step.rds"))
...
saveRDS(out, "output/summaries/parameteric_univariate.rds")
...
saveRDS(out, "output/summaries/nonparameteric_univariate.rds")
saveRDS(out_all, "output/summaries/nonparameteric_univariate_raw.rds")
