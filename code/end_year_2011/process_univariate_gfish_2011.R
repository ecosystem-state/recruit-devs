...
for(i in 1:nrow(df)) {
  ...
  d = readRDS(file = paste0("output/",df$response[i],"/",df$predictors[i],"_",df$model[i],"_",df$years_ahead[i],"step_2011.rds"))
...
saveRDS(out, "output/summaries/parameteric_univariate_2011.rds")
...
saveRDS(out, "output/summaries/nonparameteric_univariate_2011.rds")
saveRDS(out_all, "output/summaries/nonparameteric_univariate_raw_2011.rds")
