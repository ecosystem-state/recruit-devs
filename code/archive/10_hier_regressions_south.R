...
results_calcofi_2spp = list(all_results = spp_combo,
                            best_dat = best_dat)
saveRDS(results_calcofi_2spp, "fitted_models/results_calcofi_2spp.rds")
...
results_calcofi_3spp = list(all_results = spp_combo,
                            best_dat = best_dat)
saveRDS(results_calcofi_3spp, "fitted_models/results_calcofi_3spp.rds")
